 ...
 */
exports.isAuthenticated = (req, res, next) => (req.isAuthenticated() ? next() : res.redirect('/'));

/**
 * Required Not-logged-in middleware.
 */
exports.isUnauthenticated = (req, res, next) => (!req.isAuthenticated() ? next() : res.redirect('/'));
